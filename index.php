            ...
            <div class="swiper-wrapper">
                <div class="intro11-section swiper-slide slide-1 slide-bg-1 bg-position">
                    ...
                    <div class="intro11-content text-left">
                        ...
                        <h2 class="title">2024 Skyna Studio</h2>
                        <p class="desc-content">Kami menydiakan berbagai jenis gantungan kunci sesuai dengan selera anda </p>
                    </div>
                    <!-- Intro Content End -->
                </div>
                <div class="intro11-section swiper-slide slide-2 slide-bg-1 bg-position">
                    ...
                    <div class="intro11-content text-left">
                        ...
                        <h2 class="title">Gantugan Kunci<br> yang penuh kreasi </h2>
                        <p class="desc-content">Gantungan kunci sesuai dengan passion</p>
                    </div>
                    <!-- Intro Content End -->
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-custom">
                            <div class="section-title text-center mb-30">
                                ...
                                <a class="buttonpesan" href="pesan.html"><button>Belanja Sekarang</button></a>
                            </div>
